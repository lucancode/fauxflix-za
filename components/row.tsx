...
const row = ({ title, media }: Props) => {
  ...
  return (
    <div className={`relative h-40 mb-12 space-y-0.5 md:space-y-2 md:mb-16`}>
      <h2 className="cursor-default mt-4 mb-2 md:mt-14 font-semibold md:text-2xl text-[#cccccc] transition duration-200 hover:text-white">
        {title}
      </h2>
        ...
        >
          {media.map((movie) => (
            <div
              ...
              className={`relative h-40 min-w-[180px] cursor-pointer transition duration-200 ease-out md:h-36 md:min-w-[263px] md:hover:scale-105`}
            >
              <Image
